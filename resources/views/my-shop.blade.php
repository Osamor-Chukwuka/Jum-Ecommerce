...
<section id="pricing" class="bg-light  pt-1">
                    ...
                    <div class="card border-0 mb-3 mt-3">
                        <div class="card-body text-center py-4">
                            ...
                            <a class="p text-black" href="/products/full/">
                                <p class="display-7 text-secondary fw-bold">{{$shopp_products->name}}</p>
                                {{-- <p class="display-7 lead my-4 text-secondary fw-bold">{{$relation->price}}</p> --}}
                            </a>
                            
                            <p class="h4 text-primary fw-bold">{{'N'. $shopp_products->price}}</p>
