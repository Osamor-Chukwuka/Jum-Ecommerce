    ...
    <div id="app" class="fixed-top">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <!-- Search -->
                <form action="">
                    <div class="mt-1 mx-5 center navbar-brand ">
                        <input type="text" name="search" class="input ms-4 pe-5 w-100 bg-light border-1 border-success " placeholder="Search Jum..." />
